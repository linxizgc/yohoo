...
public class MainTest1 {
    ...
    public static void main(String[] args) {
        ...
        sb.append(
                ...
                .append("xmlns:web=\"http://WebXml.com.cn/\">" +
                        "<soapenv:Header/>" +
                        "<soapenv:Body>")
                .append("<web:getWeatherbyCityName>" +
                        "<web:theCityName>重庆</web:theCityName>"+
        ...
        String resultXml = sendSoapPost(url, dataXml, contentType,soapAction);
